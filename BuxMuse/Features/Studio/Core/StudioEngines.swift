...
public final class StudioClientEngine {
...
public final class StudioInvoiceEngine {
    ...
    public static func analyzeInvoice(
        ...
        client: StudioClient?,
        profile: StudioProfile,
        historicalInvoices: [StudioInvoice]
    ) -> InvoiceIntelligence {
...
public final class StudioProjectEngine {
...
public final class StudioReceiptEngine {
    public static func parseReceipt(
        ...
        let request = VNRecognizeTextRequest { request, error in
            ...
            guard let observations = request.results as? [VNRecognizedTextObservation] else {
                completion(.failure(NSError(domain: "StudioReceiptEngine", code: -2, userInfo: [NSLocalizedDescriptionKey: "No text blocks detected"])))
                return
            }
...
public final class StudioTaxEngine {
    public static func computeEstimatedTax(
        ...
        // 2. Gather Deductible Expenses (percentage-aware business expenses + mileage allowance)
        let totalDeductions = StudioDeductionMath.totalDeductible(
            receipts: receipts,
...
public final class StudioCashflowEngine {
...
public final class StudioDeductionEngine {
    public static func computeDeductions(
        ...
        let businessMiles = MileageBrain.businessDistanceTotal(entries: mileageEntries)
        if businessMiles > 0, mileageRatePerUnit > 0 {
...
public final class StudioInvoicePDFRenderer {
    public static func generatePDF(
        ...
        return renderer.pdfData { context in
            ...
            billY += 14
            for line in recipientBlock.lines.prefix(5) {
                line.draw(at: CGPoint(x: 40, y: billY), withAttributes: [.font: bodyFont])
                billY += 12
            }
            ...
            if legal.isVisible {
                ...
                for line in legal.lines {
                    line.draw(in: CGRect(x: 40, y: legalY, width: 532, height: 10), withAttributes: [
