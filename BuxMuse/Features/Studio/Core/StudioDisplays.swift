...
public struct StudioHubDisplay: Equatable {
    public var hero: StudioHeroDisplay
    public var invoicesSummary: StudioInvoiceSummaryDisplay
    public var topClients: [StudioClientDisplay]
    public var taxSummary: StudioTaxDisplay
    public var cashflow: StudioCashflowDisplay
    public var projectsSummary: StudioProjectsDisplay
    public var receiptsSummary: StudioReceiptsDisplay
    public var deductionOpportunities: [StudioDeductionDisplay]
    public var alerts: [StudioAlertDisplay]
    public var isEmpty: Bool

    public static let empty = StudioHubDisplay(
        hero: .empty,
...
public struct StudioHeroDisplay: Equatable {
    ...
    public static let empty = StudioHeroDisplay(
        businessTitle: "Set Up Your Business",
        businessSubtitle: "Studio workspace",
...
public struct StudioInvoiceSummaryDisplay: Equatable {
    ...
    public static let empty = StudioInvoiceSummaryDisplay(
...
public struct StudioClientDisplay: Identifiable, Equatable {
    public var id: UUID
...
public struct StudioTaxDisplay: Equatable {
    ...
    public static let empty = StudioTaxDisplay(
...
public struct StudioCashflowDisplay: Equatable {
    public var runwayMonthsFormatted: String
    ...
    /// Last 6 months paid-invoice totals for hub sparkline.
    public var inflowSparklinePoints: [Double]

    public static let empty = StudioCashflowDisplay(
        runwayMonthsFormatted: "—",
        ...
        inflowSparklinePoints: []
    )
}

public struct StudioProjectsDisplay: Equatable {
    public var activeCount: Int
    public var overrunRiskCount: Int
    public var topProjectName: String?
    public var topProjectProfitFormatted: String?

    public static let empty = StudioProjectsDisplay(
        activeCount: 0,
        overrunRiskCount: 0,
        topProjectName: nil,
...
public struct StudioReceiptsDisplay: Equatable {
    public var totalCount: Int
    public var deductibleTotalFormatted: String
    public var thisMonthCount: Int

    public static let empty = StudioReceiptsDisplay(
        totalCount: 0,
...
public struct StudioDeductionDisplay: Identifiable, Equatable {
    public var id: UUID
...
public struct StudioAlertDisplay: Identifiable, Equatable {
...
public enum TaxReferenceCopy {
    public static let disclaimer = "Tax rules vary by country. Always verify with your local tax authority."
    public static let monthlyDataBanner = "Tax data updates monthly. Always verify with your local tax authority for accuracy."
    public static let coachFooter = "Tax rules vary by country. Always verify with your local tax authority."
}
...
public struct StudioDeductionsSnapshotDisplay: Equatable {
    public var totalFormatted: String
    public var mileageSummaryFormatted: String?
    public var opportunities: [StudioDeductionDisplay]

    public static let empty = StudioDeductionsSnapshotDisplay(
        totalFormatted: "—",
        mileageSummaryFormatted: nil,
        opportunities: []
    )
}
