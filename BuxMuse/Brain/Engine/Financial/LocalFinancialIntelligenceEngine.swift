//
//  LocalFinancialIntelligenceEngine.swift
//  BuxMuse
//  Brain/Engine/Financial/
//
//  Vibrant modern iOS 26 Swift Observation-powered local intelligence engine.
//
...
@available(iOS 26, *)
@Observable
public final class LocalFinancialIntelligenceEngine: FinancialIntelligenceEngine {
    ...
    public func categorySummaries(for range: DateInterval) -> [CategorySummary] {
        ...
        for category in TransactionCategory.allCases {
            ...
            if totalPrevDecimal != 0 {
                ...
                // If there was no spending in the previous period, but there is now, it's a 100% increase
                trend = 100.0
            }
            
            // Average per month fallback representation
    ...
    public func savingsOpportunities(for range: DateInterval) -> [SavingsOpportunity] {
        ...
        // Sort descending to find the top categories
        ...
        for summary in topCategories {
            ...
            if baseline != 0 {
                ...
                if currentVal > baselineVal {
                    // Category is consistently high, above baseline, and in top 2
    ...
    private func baselineForCategory(_ category: TransactionCategory, referenceDate: Date) -> Decimal {
        ...
        // Find distinct months in this range with active transactions
